...
class EnumType extends DefaultType
{
    ...
    public function html($parameters = [])
    {
        ...
        return "<div class='twa-table-td-select !min-w-36 !px-2 !py-[6px] flex justify-center ' style='background-color:".$selectedEnum->BgColor().";color: ".$selectedEnum->TextColor()." ;' ><span>{$selectedEnum->label()}</span></div>";
    }
}
