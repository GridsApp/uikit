...
class EnumType extends DefaultType
{
    ...
    public function html($parameters = [])
    {
        ...
        return "<div class='twa-table-td-select w-fit !px-16 !py-[6px] flex justify-center ' style='background-color:".$selectedEnum->BgColor().";color: ".$selectedEnum->TextColor()." ;' ><span>{$selectedEnum->label()}</span></div>";
    }
}
